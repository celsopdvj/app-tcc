    ...
    return Scaffold(
      ...
      body: 
         ...
         child: Column(
             ...
             children: <Widget>[
               Card(child: Text("Segunda", style: textStyle),),
               ...
               Card(child: Text("Terça", style: textStyle),),
               ...
               Card(child: Text("Quarta", style: textStyle),),
               ...
               Card(child: Text("Quinta", style: textStyle),),
               ...
               Card(child: Text("Sexta", style: textStyle),),
              ...
              //REVER QUANTAS AULAS TEM
               Card(child: Text("Sábado", style: textStyle,),),
